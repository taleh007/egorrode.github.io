...
d3.select(self.frameElement).style("width", "1890px")// (w*2 + pad.left + pad.right + pad.middle + pad.text + 75) + "px");
d3.select(self.frameElement).style("height", "1080px")// (h + pad.top + pad.bottom + 20 + 80) + "px");
